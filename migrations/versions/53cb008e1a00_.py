...
Revision ID: 53cb008e1a00
Revises: e0a9c4db98a4
Create Date: 2022-04-08 15:08:06.856687
...
revision = '53cb008e1a00'
down_revision = 'e0a9c4db98a4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('valla', sa.Column('type_id', sa.Integer(), nullable=True))

...
Revision ID: 24b14e42e2b9
Revises: 557e2644bb39
Create Date: 2022-04-08 15:04:59.490539
...
revision = '24b14e42e2b9'
down_revision = '557e2644bb39'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('user', 'created',
               existing_type=postgresql.TIMESTAMP(),
               nullable=False)
    op.add_column('valla', sa.Column('comment', sa.Text(), nullable=False))
